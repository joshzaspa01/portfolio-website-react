                ...
                <div className="content_section">
                    ...
                    <animated.div style={fade} className="about_me_descriptions">
                        ...
                        <p className="description">
                            ...
                            <span> Adobe Illustrator</span>, and <span> Adobe XD</span>, as well as front-end stack like <span> HTML</span>, 
                            <span> CSS</span>, and <span> JavaScript</span>. And also, I have a basic understanding about <span>ReactJS</span>, <span>Python</span>, <span> Java</span>, and Version Control <span>Git / Github</span>.
                            <br/><br/>
